...
function obtenerlatlongAll($strHostMYSQL,$strUserMYSQL,$strPWDMYSQL,$strDBMYSQL){
	...
	else
	{
		...
		$anno=date("Y");
		$str="SELECT u.iduser,u.latitud,u.longitud,p.sobremi,(6371 * ACOS(SIN(RADIANS(u.latitud)) * SIN(RADIANS(19.4456375))+ COS(RADIANS(u.longitud - -99.119641)) * COS(RADIANS(u.latitud)) * COS(RADIANS(19.4456375))
