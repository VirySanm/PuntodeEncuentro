        ...
        if (results[0]) {
         // map.fitBounds(results[0].geometry.viewport);
                 ...
                 // marker.setPosition(latlng);
                  ...
                  dir=direc.split(",");
                  cp=dir[2].split(" ");
                  direccion="Col. "+dir[1]+", "+cp[2]+","+dir[3]+","+dir[4];
  ...
  <div class="page-content container-fluid">
          ...
          <div class="widget-footer">
            ...
            <?php if($datosPerfil[6]!="" || $datosPerfil[7]!="" || $datosPerfil[8]!=""){?>
              ...
              <div class="col-xs-4">
               ...
               <a href="profile.php?c=2" style="cursor: pointer">
                <span>Agregado</span>
                </a>
              </div>
              <div class="col-xs-4">
                <strong class="profile-stat-count"><?php echo $datosPerfil[8] ?></strong>
               <a href="profile.php?c=3" style="cursor: pointer">
                <span>Vistas</span>
                </a>
              </div>
              <?php }?>
        ...
        <div class="panel">
          <div class="panel-body nav-tabs-animate">
            <ul class="nav nav-tabs nav-tabs-line" data-plugin="nav-tabs" role="tablist">
             ...
             $ag="";
             $agr="class='tab-pane animation-slide-left'";
             $vi="";
             $vis="class='tab-pane animation-slide-left'";
            if($_GET["c"]==0)
            {
              $c="class='active'";
            ...
            {
              $ag="class='active'";
              $agr="class='tab-pane active animation-slide-left'";
            }
            if($_GET["c"]==3)
            {
              $vi="class='active'";
              $vis="class='tab-pane active animation-slide-left'";
            }
          ?>
              ...
              <li <?php echo $ag ?> id="agr" role="presentation"><a data-toggle="tab" href="#agregados" aria-controls="agregados" role="tab">Te Agreg&oacute;</a></li>
              <li <?php echo $vi ?> id="vis" role="presentation"><a data-toggle="tab" href="#visita" aria-controls="visita" role="tab">Visitas</a></li>
            </ul>
	...
	else
	{
		...
		else
		{
        	...
        	else
        	{
        		...
        		else
        		{
        			while($row=mysql_fetch_array($Res)){
        				...
        				$confirmarusuado=usuconfir($strHostMYSQL,$strUserMYSQL,$strPWDMYSQL,$strDBMYSQL, $row["iduserAct"]);
          ...
          <div <?php echo $agr ?> id="agregados" role="tabpanel" >
            <ul class="list-group">
             <li class="list-group" style="cursor:pointer" >
                <div class="media media-lg">
                  <div class="media-left" >
          ...
          <div <?php echo $vis ?> id="visita" role="tabpanel" >
            <ul class="list-group">
             <li class="list-group" style="cursor:pointer" >
                <div class="media media-lg">
                  <div class="media-left" >
          ...
          {
            $strS ="SELECT DATE_FORMAT(fechaHRVisita,'%d-%m-%Y') AS fecha, v.iduservisitante, u.nomUser FROM visitas v, user u where v.iduservisitante=u.iduser and v.iduservisitado=".$_SESSION["iduser"]." group by fecha order by fecha desc";
            $Res = mysql_query($strS);
