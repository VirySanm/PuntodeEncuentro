    ...
    $(document).ready(function(){
     ...
     geolocalizame();
   	 ...
   	 function pedirPosicion(pos) {
   	   ...
   	   var myOptions = {
   	     zoom: 16, //nivel de zoom para poder ver de cerca.
   	     center: centro,
        ...
        <div>
          <ul class="site-menu">
            ...
            <li class="site-menu-item has-sub active open">
              ...
              <ul class="site-menu-sub">
                ...
                <li class="site-menu-item">
                  <a class="animsition-link" href="profile.php" data-slug="profile">
                    <i class="site-menu-icon " aria-hidden="true"></i>
		  ...
		  <h5>
            ...
            <span class="pull-right"><div id="age">18-<?php //echo $edad ?></div></span>
               ...
               <input id="ex2" data-slider-id='ex1Slider' type="text" data-slider-min="18" data-slider-max="55" data-slider-step="1" data-slider-value="<?php echo $edad ?>"/>
